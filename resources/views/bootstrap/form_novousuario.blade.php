...
<div class="container">
    <fieldset>
        ...
        <form action="http://{{$_SERVER["HTTP_HOST"]}}/admin/cadnewuser/" method="POST">
            @csrf
        <div class="col-md-8">
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                  <button class="nav-link active" id="nav-cliente-tab" data-bs-toggle="tab" data-bs-target="#nav-cliente" type="button" role="tab" aria-controls="nav-home" aria-selected="true"><span class="fa fa-user"></span> Usuário</button>
                  <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false"><span class="fa fa-users[j00çl.."></span> Usuarios</button>
              ...
              <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-cliente" role="tabpanel" aria-labelledby="nav-cliente-tab">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-3">
                            <input type="password" placeholder="Abc1234" name="passkey" class="form-control">
                        </div>
                        <div class="col-sm-3">
